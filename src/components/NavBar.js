                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <div className="social-icon">
                                <a href="https://www.linkedin.com/in/ibrahimdkt/?originalSubdomain=ca"><img src={navIcon1} alt="linkedin" /></a>

                            </div>

                                <a href="#connect" className="connect" onClick={() => onUpdateActiveLink('connect')}>Me contacter</a>
